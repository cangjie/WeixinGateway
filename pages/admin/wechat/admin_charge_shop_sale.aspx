        ...
        function get_qrcode() {
            ...
            $.ajax({
                ...
                success: function (msg, status) {
                    ...
                    var qr_code_url = "";
                    //if (qrcode_id != null) {
                    qr_code_url = "http://weixin.snowmeet.top/show_qrcode.aspx?sceneid=" + qrcode_id.trim();
                    //}
                    //else {
                    //    qr_code_url = "http://weixin.snowmeet.top/show_qrcode.aspx?qrcodetext=" + msg_object.qr_code_url.trim();
                    //}
