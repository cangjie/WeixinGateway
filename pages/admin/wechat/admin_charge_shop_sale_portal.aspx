...
<head runat="server">
    ...
    <script type="text/javascript" >
        ...
        function cell_number_charge() {
            ...
            if ((cell_number.substr(0, 2) == '13' || cell_number.substr(0, 2) == '15'
                || cell_number.substr(0, 2) == '17' || cell_number.substr(0, 2) == '18'
                || cell_number.substr(0, 2) == '19'  )
                && cell_number.length == 11) {
