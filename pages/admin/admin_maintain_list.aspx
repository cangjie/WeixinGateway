...
<script runat="server">
    ...
    {
        DateTime start = DateTime.Parse(Util.GetSafeRequestValue(Request, "start", "2020-11-1"));
        DateTime end = DateTime.Parse(Util.GetSafeRequestValue(Request, "start", "2021-4-30"));
