...
<script runat="server">
    ...
    {
        DateTime start = DateTime.Parse(Util.GetSafeRequestValue(Request, "start", "2022-11-1"));
        DateTime end = DateTime.Parse(Util.GetSafeRequestValue(Request, "end", "2023-5-30"));
