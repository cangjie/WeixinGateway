...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string md5Key = System.Configuration.ConfigurationSettings.AppSettings["haojin_app_key_bayi_goods"];
        string appCode = System.Configuration.ConfigurationSettings.AppSettings["haojin_app_id_bayi_goods"];
        if (order.OrderDetails[0].productId == 2 || order.OrderDetails[0].productId == 4)
        {
            md5Key = System.Configuration.ConfigurationSettings.AppSettings["haojin_app_key_bayi_goods"];
            appCode = System.Configuration.ConfigurationSettings.AppSettings["haojin_app_id_bayi_goods"];
        }
